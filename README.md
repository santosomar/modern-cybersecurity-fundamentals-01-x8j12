# Modern Cybersecurity Fundamentals Day 1
...
- The basics on incident response, digital forensics, network and host telemetry, PenTesting, cloud security, AI security, and so much more

And you’ll be able to:
- Learn the fundamentals of the major cybersecurity concentrations such as incident response, digital forensics, ethical hacking, AI security, governance, compliance, and risk management
...
**Cyber Security Foundational Concepts (60 minutes)**
...
**Zero Trust Architecture (ZTA) (45 minutes)**
- Principles of Zero Trust (Never Trust, Always Verify)
- Micro-segmentation and Network Security
- Continuous Authentication and Authorization
- Implementing ZTA in Modern Enterprises

*Break (10 minutes)*

**Identity and Access Management (IAM) Deep Dive (45 minutes)**
- IAM Principles and the New Perimeter
...
**Social Engineering & Phishing (35 minutes)**
- The Human Element of Cybersecurity
- Psychological Manipulation Techniques
- Types of Phishing (Spear Phishing, Whaling, Vishing)
...
**Introduction to AI Security (35 minutes)**
- Understanding AI Threats and Vulnerabilities
- Securing Machine Learning Models
- Governance and Compliance in AI
- AI in Adversarial Tactics and Defense

*Break (10 minutes)*

**Application Security (AppSec) & Secure Coding (45 minutes)**
...
**Supply Chain Security (35 minutes)**
- Understanding Software Supply Chain Risks
- Case Studies: SolarWinds and Similar Attacks
